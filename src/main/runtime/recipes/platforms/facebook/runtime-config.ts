...
const FACEBOOK_CAPABILITIES: RecipeCapabilities = {
...
export const FACEBOOK_LEGACY_RUNTIME_CONFIG_OVERRIDES = {
  userLogged:
...
export function buildFacebookRecipeRuntimeConfig(_payload: RecipeInitPayload): RecipeRuntimeConfig {
  return {
    selectors: {
      appRoot:
    ...
    legacyConfig: { ...FACEBOOK_LEGACY_RUNTIME_CONFIG_OVERRIDES },
  };
}
