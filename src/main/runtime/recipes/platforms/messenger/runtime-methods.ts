...
export const MESSENGER_LEGACY_METHOD_BINDINGS: readonly RecipeLegacyMethodBinding[] = [
...
export function buildMessengerRecipeRuntimeMethods(): RecipeRuntimeMethods {
  return {};
}
